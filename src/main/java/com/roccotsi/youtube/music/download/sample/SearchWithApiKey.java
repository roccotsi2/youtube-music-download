...
public class SearchWithApiKey {
	...
	public static void main(String[] args) {
		...
		try {
			InputStream in = SearchWithApiKey.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
			properties.load(in);
	 ...
	 */
	private static void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query, String apiKey)
			throws IOException {
